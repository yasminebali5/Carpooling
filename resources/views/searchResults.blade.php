                ...
                @auth
                    ...
                    @foreach($retrievedRides as $ride)
                        <tr>
                            ...
                            <td>{{$ride->departureTime}}</td>
                            <td>{{$ride->price . " DT"}}</td>
                            <td>{{$ride->availableSeats - $ride->passengers_count}}</td>
