...
@section('content')
    ...
    @if($futureRidesAsDriver->merge($futureRidesAsPassenger)->isEmpty())
        <div class="container d-flex justify-content-center">
            <div class="row">
                <h1>{{"Pas de chemins Actuellement." }}</h1>
            </div>
        </div>
    @else
            ...
            <div class="container">
                ...
                <table class="table table-striped" id="tblRidesAsDriver">
                    ...
                    <tr>
                        ...
                        <th scope="col">Horaire depart</th>
                        <th scope="col">Prix(DT) </th>
                        <th scope="col">Places Disponibles</th>
                        <th scope="col">Places Reserves</th>
                    ...
                    @foreach($futureRidesAsDriver as $ride)
                        <tr>
                            ...
                            <td>{{$ride->price . " DT"}}</td>
                            <td>{{$ride->availableSeats - $ride->passengers->count()}}</td>
    ...
    <div class="container d-flex justify-content-center mt-5">
        ...
        <a class="btn btn-primary btn-lg mb-4 ms-3" type="button" href=" {{route('home.create')}} "><i
                class="bi bi-plus-circle me-2"></i>Creer une Offre</a>
    </div>
